...
">
        <div class="mx-auto max-w-md px-6 py-12 bg-white border-0 shadow-lg sm:rounded-3xl">
            ...
            <form action="<?= BASE_URL ?>/task/update_Task" class=space-y-6" method="post">
                ...
                <div>
                    ...
                    <input type="text" name="task-title" id="task-title" class="bg-gray-50 border shadow border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-white  dark:placeholder-gray-400" value="<?= $task['title'] ?>" placeholder="Task Title" required>
                </div>
                <div>
                    <label for="description" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Task Description</label>
                    <textarea name="task-description" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 dark:bg-white shadow dark:placeholder-gray-400" placeholder="Write your task description here..."><?=$task['description']; ?></textarea>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input name="date" type="date" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg block w-full pl-10 py-2.5 px-1  dark:bg-white shadow dark:placeholder-gray-400  " value="<?= $task['deadline'] ?>" placeholder="Select date">
                    </div>
                </div>
