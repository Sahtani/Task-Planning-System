                ...
                ?>
                        ...
                        <div class="mt-10 max-w-sm p-6 bg-white border  rounded-lg shadow bg-white">
                            ...
                            <div class="flex flex-row items-center justify-center gap-10">
                                ...
                                <a href="<?= BASE_URL ?>/task" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg focus:outline-none  dark:bg-blue-400" name="addtask">
